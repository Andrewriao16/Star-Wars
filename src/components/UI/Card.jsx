            ...
            {source === "d" ? (
                <>
                    <div className="rounded overflow-hidden shadow bg-gray-100">
                        <div className="px-6 py-4">
                            ...
                            <br/>
                            <p><span className='font-bold'>Producer:</span> {p?.producer}</p>
                            <br/>
                ...
                <div className="rounded overflow-hidden shadow bg-gray-100">
                    ...
                    <div className="px-6 pt-4 pb-2 flex justify-between align-middle">
                        <button onClick={() => { seeMore(p) }} className="bg-cyan-500 hover:bg-slate-400 text-white font-bold py-2 px-4 rounded-full">
